...
public class MainController {
    ...
    public String usersProfilePage(@PathVariable(name = "userId") Long userId, Model model){
        ...
        model.addAttribute("likedPosts", likeService.getLikedPostsOfUser(userService.getCurrentUser(), posts));
        return "profile";
    }
    ...
    public String addLike(Like like, @RequestParam(name = "direction") String direction){
    ...
    public String deleteLike(Like like, @RequestParam(name = "direction") String direction){
